...
void gf256v_mul_scalar_sse( uint8_t * a, uint8_t _b , unsigned _num_byte ) {
	unsigned b = _b;
	__m128i ml = _mm_load_si128( (__m128i*) (PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf256_mul + 32*b) );
	__m128i mh = _mm_load_si128( (__m128i*) (PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf256_mul + 32*b + 16) );
	__m128i mask = _mm_set1_epi8(0xf);
...
void gf16v_generate_multab_16_sse( uint8_t * _multab_byte , const uint8_t * _x0 )
{
	...
	for(unsigned j=0;j<16;j++) {
		__m128i mt = _mm_load_si128( (__m128i*) (PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_mulx2 + 32*j) );
...
void gf256v_generate_multab_sse( uint8_t * _multabs , const uint8_t * _x , unsigned n )
{
	...
	__m128i mul_8 = _mm_load_si128( (__m128i*)(PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_mulx2 + 32*8) );

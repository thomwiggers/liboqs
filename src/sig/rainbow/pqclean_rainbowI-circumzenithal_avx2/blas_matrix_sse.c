...
#include "assert.h"  /// XXX: remove this
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_add_multab_sse( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
	assert( n_A_vec_byte <= 512 );
	__m128i tmp_c[32];
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_sse( (uint8_t*) tmp_c , matA , n_A_vec_byte , n_A_width , multab );
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_sse( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
...
#if 0
// slower
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_sse( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_sse( c , matA , n_A_vec_byte , n_A_width , multab );
}
#endif


void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_16_sse( uint8_t * c , const uint8_t * mat_a , unsigned a_w , const uint8_t * b ) {
	assert( 0 == (a_w&0x1f) );
	__m128i mask_f = _mm_set1_epi8(0xf);
...
// faster
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_sse( uint8_t * c , const uint8_t * mat_a , unsigned a_h_byte , unsigned a_w , const uint8_t * b ) {
	if( 16==a_h_byte && (0==(a_w&0x1f)) ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_16_sse(c,mat_a,a_w,b); return; }
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_add_multab_sse( __m128i * r , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
	__m128i mask_f = _mm_set1_epi8(0xf);
	unsigned n_xmm = ((n_A_vec_byte + 15)>>4);
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_multab_sse( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
	...
	if(0==n_A_width) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_set_zero(c,n_A_vec_byte);  return; }
	if(1 < n_A_width) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_add_multab_sse( r , matA, n_A_vec_byte , n_A_width - 1 , multab );
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_add_sse( __m128i * r , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {

	uint8_t multab[16*16*2] __attribute__((aligned(32)));
	while( 16 < n_A_width ){
		gf256v_generate_multab_sse( multab , b , 16 );
		PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_add_multab_sse( r , matA , n_A_vec_byte , 16 , multab );
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_sse( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_add_sse( r , matA , n_A_vec_byte , n_A_width , b );
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_inv_32x32_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	//const unsigned h=32;
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_set_zero( mat , 32*32 );
	return r8;
}


unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_solve_linear_eq_32x32_sse( uint8_t * sol , const uint8_t * inp_mat , const uint8_t * c_terms )
{
	//const unsigned n = 32;

	uint8_t mat[ 32*16 ] __attribute__((aligned(32)));
	unsigned r8 = PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_inv_32x32_sse( mat , inp_mat );
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_sse( sol , mat , 16 , 32 , c_terms );

	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_set_zero( mat , 32*16 );
	return r8;
}
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_inv_32x32_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 32;
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_set_zero( mat , h*vec_len );
	return r;
}

unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_solve_linear_eq_48x48_sse( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 48;
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_sse( sol , mat , h , h , c_terms );
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_inv_36x36_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 36;
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_solve_linear_eq_64x64_sse( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 64;

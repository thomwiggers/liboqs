...
{
	__m256i tab_l = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_inv );
	return _mm256_shuffle_epi8(tab_l,a);
}

static inline __m256i tbl32_gf16_log( __m256i a )
{
	__m256i tab_l = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_log );
	return _mm256_shuffle_epi8(tab_l,a);
}

static inline __m256i tbl32_gf16_exp( __m256i a )
{
	__m256i tab_l = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_exp );
	return _mm256_shuffle_epi8(tab_l,a);
}
...
{
	__m256i tab_l = _mm256_load_si256((__m256i const *) (PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_mulx2+  8*32 ));
...
{
	return tbl32_gf16_mul_log_log( tbl32_gf16_log(a) , tbl32_gf16_log(b) , _mm256_load_si256((__m256i const *)PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___mask_low ) );
}
...
static inline __m256i tbl32_gf256_mul_const( unsigned char a , __m256i b )
{
	...
	__m256i tab = _mm256_load_si256((__m256i const *) (PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf256_mul+  ((unsigned)a)*32 ));
...
{
	__m256i mask_f = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___mask_low);
	__m256i log_16 = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_log);
	__m256i exp_16 = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___gf16_exp);

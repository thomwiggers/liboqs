...
static inline __m128i tbl_gf256_set_value( unsigned char a ) {
...
static inline unsigned char tbl_gf256_get_1st_value( __m128i a ) {
    return (_mm_extract_epi16(a, 0) & 0xff);
}

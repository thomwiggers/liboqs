...
error:
    ...
    for (unsigned i = 0; i < 8192 + 1024 + 128; i++) {
        idx_to_loc[i] = i;
    }
    for (unsigned i = 0; i < 8192 + 1024 + 128; i++) {
        loc_to_idx[i] = i;
...
#define _SIZE_BUFFER_F3 (_O1_BYTE * _V1 * _O2)
    ...
    memset( Qs->l1_Q5, 0, _O1_BYTE * N_TRIANGLE_TERMS(_O1) );
    PQCLEAN_RAINBOWIACYCLIC_AVX2_UpperTrianglize( Qs->l1_Q5, buffer_F3, _O1, _O1_BYTE );                          // UT( ... )   // Q5 , release buffer_F3
    ...
    */
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_UpperTrianglize( Qs->l1_Q9, buffer_F3, _O2, _O1_BYTE );                               // Q9 , release buffer_F3
...
#define calculate_Q_from_F_impl        PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_Q_from_F_simd
#define calculate_F_from_Q_impl        PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_F_from_Q_simd
#define calculate_Q_from_F_cyclic_impl PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_Q_from_F_cyclic_simd

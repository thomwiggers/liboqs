...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_extcpk_to_pk( pk_t * pk , const ext_cpk_t * cpk )
{
...
#define calculate_Q_from_F_impl        PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F_simd
#define calculate_F_from_Q_impl        PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q_simd
#define calculate_Q_from_F_cyclic_impl PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F_cyclic_simd
...
error: incorrect buffer size.
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l1_Q5 , tempQ , _O1, _O1_BYTE );    // UT( ... )   // Q5
...
*/
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l1_Q9 , tempQ , _O2 , _O1_BYTE );                                   // Q9
...
*/
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l2_Q5 , tempQ , _O1, _O2_BYTE );                                     // UT( ... )   // Q5
...
*/
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l2_Q9 , tempQ , _O2 , _O2_BYTE );                                   // Q9
...
*/
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Fs->l2_F5 , tempQ , _O1, _O2_BYTE );                                  // UT( ... )
...
#define _SIZE_BUFFER_F3 (_O2_BYTE * _V1 * _O2)
    ...
    memset( Qs->l1_Q5 , 0 , _O1_BYTE * N_TRIANGLE_TERMS(_O1) );
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l1_Q5 , buffer_F3 , _O1, _O1_BYTE );                        // UT( ... )   // Q5 , release buffer_F3
...
*/
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l1_Q9 , buffer_F3 , _O2 , _O1_BYTE );                            // Q9 , release buffer_F3
...
error: incorrect buffer size.
    ...
    memset( Qs->l2_Q9 , 0 , _O2_BYTE * N_TRIANGLE_TERMS(_O2) );
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_UpperTrianglize( Qs->l2_Q9 , buffer_F2 , _O2 , _O2_BYTE );                              // Q9
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F( ext_cpk_t * Qs, const sk_t * Fs , const sk_t * Ts )
{
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q( sk_t * Fs , const sk_t * Qs , const sk_t * Ts )
{
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F_cyclic( cpk_t * Qs, const sk_t * Fs , const sk_t * Ts )
{

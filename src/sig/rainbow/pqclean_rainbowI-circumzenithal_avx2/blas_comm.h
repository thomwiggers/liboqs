...
///
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_set_zero(uint8_t *b, unsigned _num_byte);
...
///
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256v_is_zero(const uint8_t *a, unsigned _num_byte);

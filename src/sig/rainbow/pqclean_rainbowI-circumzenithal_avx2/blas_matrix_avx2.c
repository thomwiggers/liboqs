...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_16_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_width , const uint8_t * multab ) {
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
	if( 16 == n_A_vec_byte && (0==(n_A_width&1)) ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_16_multab_avx2(c,matA,n_A_width,multab); return; }
	assert( n_A_width <= 256 );
	assert( n_A_vec_byte <= 512 );
	if( 16 >= n_A_vec_byte ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_sse(c,matA,n_A_vec_byte,n_A_width,multab); return; }

	__m256i mask_f = _mm256_load_si256( (__m256i*)PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___mask_low);
...
#if 0
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_multab_avx2( c , matA , n_A_vec_byte , n_A_width , multab );
}
#else
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_avx2( uint8_t * c , const uint8_t * mat_a , unsigned a_h_byte , unsigned a_w , const uint8_t * b ) {
	assert( a_w <= 256 );
	assert( a_h_byte <= 512 );
	if( 16 >= a_h_byte ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_prod_sse(c,mat_a,a_h_byte,a_w,b); return; }
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * multab ) {
	assert( n_A_width <= 256 );
	assert( n_A_vec_byte <= 64*64 );
	if( 16 >= n_A_vec_byte ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_multab_sse(c,matA,n_A_vec_byte,n_A_width,multab); return; }

	__m256i mask_f = _mm256_load_si256((__m256i const *) PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2___mask_low);
...
#if 0
// slower
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {
	assert( n_A_width <= 128 );
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_multab_avx2( c , matA , n_A_vec_byte , n_A_width , multab );
}
#else
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned n_A_vec_byte , unsigned n_A_width , const uint8_t * b ) {
	assert( n_A_width <= 256 );
	...
	if( 16 >= n_A_vec_byte ) { PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_sse(c,matA,n_A_vec_byte,n_A_width,b); return; }
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_inv_32x32_avx2(uint8_t *inv_a, const uint8_t *a )
{
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_solve_linear_eq_32x32_avx2( uint8_t * sol , const uint8_t * inp_mat , const uint8_t * c_terms )
{
	uint8_t mat[32*16] __attribute__((aligned(32)));
	unsigned r8 = PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf16mat_inv_32x32_avx2( mat , inp_mat );
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_inv_32x32_avx2( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 32;
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_solve_linear_eq_48x48_avx2( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 48;
	...
	PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_prod_avx2( sol , mat , h , h , c_terms );
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_inv_36x36_avx2( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 36;
	const unsigned vec_len = 96;
...
unsigned PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_gf256mat_solve_linear_eq_64x64_avx2( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 64;

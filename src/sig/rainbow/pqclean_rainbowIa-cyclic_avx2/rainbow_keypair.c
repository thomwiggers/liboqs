...
void generate_S_T( unsigned char *s_and_t, prng_t *prng0 ) {
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, s_and_t, _O1_BYTE * _O2 ); // S1
    s_and_t += _O1_BYTE * _O2;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, s_and_t, _V1_BYTE * _O1 ); // T1
    s_and_t += _V1_BYTE * _O1;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, s_and_t, _V1_BYTE * _O2 ); // T2
    s_and_t += _V1_BYTE * _O2;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, s_and_t, _O1_BYTE * _O2 ); // T3
}
...
unsigned generate_l1_F12( unsigned char *sk, prng_t *prng0 ) {
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O1_BYTE * N_TRIANGLE_TERMS(_V1) );   // l1_F1
    sk += _O1_BYTE * N_TRIANGLE_TERMS(_V1);
    n_byte_generated += _O1_BYTE * N_TRIANGLE_TERMS(_V1);

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O1_BYTE * _V1 * _O1 );  // l1_F2
    sk += _O1_BYTE * _V1 * _O1;
...
unsigned generate_l2_F12356( unsigned char *sk, prng_t *prng0 ) {
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O2_BYTE * N_TRIANGLE_TERMS(_V1) );   // l2_F1
    sk += _O2_BYTE * N_TRIANGLE_TERMS(_V1);
    n_byte_generated += _O2_BYTE * N_TRIANGLE_TERMS(_V1);

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O2_BYTE * _V1 * _O1 ); // l2_F2
    sk += _O2_BYTE * _V1 * _O1;
    n_byte_generated += _O2_BYTE * _V1 * _O1;

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O2_BYTE * _V1 * _O2 ); // l2_F3
    sk += _O2_BYTE * _V1 * _O1;
    n_byte_generated += _O2_BYTE * _V1 * _O1;

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O2_BYTE * N_TRIANGLE_TERMS(_O1) );   // l2_F5
    sk += _O2_BYTE * N_TRIANGLE_TERMS(_O1);
    n_byte_generated += _O2_BYTE * N_TRIANGLE_TERMS(_O1);

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( prng0, sk, _O2_BYTE * _O1 * _O2 ); // l2_F6
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_rainbow_evaluate_cpk( unsigned char *z, const cpk_t *pk, const unsigned char *w ) {
    prng_t prng0;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_set( &prng0, pk->pk_seed, LEN_PKSEED );
...
error:
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O1_BYTE * N_TRIANGLE_TERMS(_V1) );   // l1_F1
    batch_quad_trimat_eval( l1, pk_seg, v1, _V1, _O1_BYTE );

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O1_BYTE * _V1 * _O1 );  // l1_F2
    ...
    // l2
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O2_BYTE * N_TRIANGLE_TERMS(_V1) );   // l2_F1
    batch_quad_trimat_eval( l2, pk_seg, v1, _V1, _O2_BYTE );

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O2_BYTE * _V1 * _O1 ); // l2_F2
    batch_quad_recmat_eval( buffer, v1, _V1, pk_seg, o1, _O1, _O2_BYTE );
    gf256v_add( l2, buffer, _O2_BYTE );

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O2_BYTE * _V1 * _O2 ); // l2_F3
    batch_quad_recmat_eval( buffer, v1, _V1, pk_seg, o2, _O2, _O2_BYTE );
    gf256v_add( l2, buffer, _O2_BYTE );

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O2_BYTE * N_TRIANGLE_TERMS(_O1) );   // l2_F5
    batch_quad_trimat_eval( buffer, pk_seg, o1, _O1, _O2_BYTE );
    gf256v_add( l2, buffer, _O2_BYTE );

    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_gen( &prng0, pk_seg, _O2_BYTE * _O1 * _O2 ); // l2_F6
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_cpk_to_pk( pk_t *rpk, const cpk_t *cpk ) {
    ...
    // setup prng
    prng_t prng0;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_set( &prng0, cpk->pk_seed, LEN_PKSEED );
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_extcpk_to_pk( rpk, pk );
...
void _generate_secretkey( sk_t *sk, const unsigned char *sk_seed ) {
    ...
    // set up prng
    prng_t prng0;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_set( &prng0, sk_seed, LEN_SKSEED );
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_generate_keypair( pk_t *rpk, sk_t *sk, const unsigned char *sk_seed ) {
    _generate_secretkey( sk, sk_seed );
    ...
    ext_cpk_t *pk = &_pk;
    #endif
    PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_Q_from_F( pk, sk, sk );    // compute the public key in ext_cpk_t format.
    calculate_t4( sk->t4, sk->t1, sk->t3 );
    ...
    #if defined(_USE_MEMORY_SAVE_)
    PQCLEAN_RAINBOWIACYCLIC_AVX2_extcpk_to_pk_inplace( rpk );     // convert the public key from ext_cpk_t to pk_t.
    #else
    PQCLEAN_RAINBOWIACYCLIC_AVX2_extcpk_to_pk( rpk, pk );      // convert the public key from ext_cpk_t to pk_t.
    #endif
}
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_generate_secretkey_cyclic( sk_t *sk, const unsigned char *pk_seed, const unsigned char *sk_seed ) {
    ...
    sk_t *Qs = &inst_Qs;
    prng_t *prng1 = &_prng;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_prng_set( prng1, pk_seed, LEN_PKSEED );
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_F_from_Q( sk, Qs, sk );
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_generate_keypair_cyclic( cpk_t *pk, sk_t *sk, const unsigned char *pk_seed, const unsigned char *sk_seed ) {
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_F_from_Q( sk, Qs, sk );            // calcuate the rest parts of secret key from Qs and S,T
    ...
    PQCLEAN_RAINBOWIACYCLIC_AVX2_calculate_Q_from_F_cyclic( pk, sk, sk );     // calculate the rest parts of public key: l1_Q3, l1_Q5, l1_Q6, l1_Q9, l2_Q9
...
void PQCLEAN_RAINBOWIACYCLIC_AVX2_generate_compact_keypair_cyclic( cpk_t *pk, csk_t *rsk, const unsigned char *pk_seed, const unsigned char *sk_seed ) {
    memcpy( rsk->pk_seed, pk_seed, LEN_PKSEED );
    memcpy( rsk->sk_seed, sk_seed, LEN_SKSEED );

    sk_t _sk;
    sk_t *sk = &_sk;
    PQCLEAN_RAINBOWIACYCLIC_AVX2_generate_keypair_cyclic( pk, sk, pk_seed, sk_seed );

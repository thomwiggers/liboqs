...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux" AND OQS_USE_AVX2_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_SIG_rainbow_Ia_cyclic_avx2 "" ON "OQS_ENABLE_SIG_rainbow_Ia_cyclic" OFF)
endif()
...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "" AND OQS_USE_AES_INSTRUCTIONS)
...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "" AND OQS_USE_AVX2_INSTRUCTIONS)

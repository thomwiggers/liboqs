...
void generate_S_T( unsigned char * s_and_t , prng_t * prng0 )
{
    ...
    size = sizeof(_sk->s1);
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_prng_gen( prng0 , s_and_t , size );
    s_and_t += size;
...
unsigned generate_l1_F12( unsigned char * sk, prng_t * prng0 )
{
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_prng_gen( prng0 , sk , size );
    sk += size;
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_cpk_to_pk( pk_t * rpk, const cpk_t * cpk )
{
    ...
    // setup prng
    prng_t prng0;
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_prng_set( &prng0 , cpk->pk_seed , LEN_PKSEED );
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_extcpk_to_pk( rpk , pk );
...
{
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->sk_seed:" , sk->sk_seed , LEN_SKSEED ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->s1 head:" , sk->s1 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->t1 head:" , sk->t1 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->t4 head:" , sk->t4 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->t3 head:" , sk->t3 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l1_F1 head:" , sk->l1_F1 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l1_F2 head:" , sk->l1_F2 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l2_F1 head:" , sk->l2_F1 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l2_F2 head:" , sk->l2_F2 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l2_F3 head:" , sk->l2_F3 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l2_F5 head:" , sk->l2_F5 , _O2_BYTE ); printf("\n");
  PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_byte_fdump(stdout, "sk->l2_F6 head:" , sk->l2_F6 , _O2_BYTE ); printf("\n");
}
#endif
...
void _generate_secretkey( sk_t* sk, const unsigned char *sk_seed )
{
    ...
    // set up prng
    prng_t prng0;
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_prng_set( &prng0 , sk_seed , LEN_SKSEED );
...
void PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_secretkey( sk_t* sk, const unsigned char *sk_seed )
{
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_sk_to_pk( pk_t * rpk , const sk_t* isk )
{
    ext_cpk_t * pk = (ext_cpk_t*)malloc(sizeof(ext_cpk_t));
    if( NULL == pk ) return -1;
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F( pk, sk , sk );   // compute the public key in ext_cpk_t format.
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_extcpk_to_pk( rpk , pk );     // convert the public key from ext_cpk_t to pk_t.
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_keypair( pk_t * rpk, sk_t* sk, const unsigned char *sk_seed )
{
    _generate_secretkey( sk , sk_seed );
...
#define PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q(a,b,c)  crypto_core_rainbowcalsecret363232((unsigned char*)a,(unsigned char*)b,(unsigned char*)c,NULL)
#elif defined( _RAINBOW256_68_32_48 )
#include "crypto_core_rainbowcalsecret683248.h"
#define PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q(a,b,c)  crypto_core_rainbowcalsecret683248((unsigned char*)a,(unsigned char*)b,(unsigned char*)c,NULL)
#elif defined( _RAINBOW256_96_36_64 )
#include "crypto_core_rainbowcalsecret963664.h"
#define PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q(a,b,c)  crypto_core_rainbowcalsecret963664((unsigned char*)a,(unsigned char*)b,(unsigned char*)c,NULL)
#else
error.
#endif
#endif
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_secretkey_cyclic( sk_t* sk, const unsigned char *pk_seed , const unsigned char *sk_seed )
{
    memcpy( sk->sk_seed , sk_seed , LEN_SKSEED );
...
#endif
    prng_t * prng1 = &_prng;
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_prng_set( prng1 , pk_seed , LEN_PKSEED );
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q( sk , Qs , sk );
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_keypair_cyclic( cpk_t * pk, sk_t* sk, const unsigned char *pk_seed , const unsigned char *sk_seed )
{
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_F_from_Q( sk , Qs , sk );          // calcuate the rest parts of secret key from Qs and S,T
    ...
    PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_calculate_Q_from_F_cyclic( pk, sk , sk );    // calculate the rest parts of public key: l1_Q3, l1_Q5, l1_Q6, l1_Q9, l2_Q9
...
int PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_compact_keypair_cyclic( cpk_t * pk, csk_t* rsk, const unsigned char *pk_seed , const unsigned char *sk_seed )
{
    ...
    sk_t * sk = &_sk;
#endif
    int r = PQCLEAN_RAINBOWICIRCUMZENITHAL_AVX2_generate_keypair_cyclic( pk , sk , pk_seed , sk_seed );
